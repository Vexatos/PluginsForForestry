...
public class EntityAIPlay extends EntityAIBase
{
    ...
    public void updateTask()
    {
        ...
        if (this.targetVillager != null)
        {
            ...
            {
                this.villagerObj.getNavigator().tryMoveToEntityLiving(this.targetVillager, this.field_48166_c);
            }
        }
        else if (this.villagerObj.getNavigator().noPath())
        {
            ...
            this.villagerObj.getNavigator().tryMoveToXYZ(var1.xCoord, var1.yCoord, var1.zCoord, this.field_48166_c);
        }
    }
}
