...
public class EntityAIAvoidEntity extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        {
            Vec3D var2 = RandomPositionGenerator.func_48623_b(this.theEntity, 16, 7, Vec3D.createVector(this.closestLivingEntity.posX, this.closestLivingEntity.posY, this.closestLivingEntity.posZ));
