...
public interface IAlleleBeeEffect extends IAlleleEffect {
	 ...
	 */
	IEffectData doEffect(IBeeGenome genome, IEffectData storedData, World world, int biomeid, int x, int y, int z);
	 ...
	 * @return storedData, may have been manipulated.
	 */
	IEffectData doFX(IBeeGenome genome, IEffectData storedData, World world, int biomeid, int x, int y, int z);
}
