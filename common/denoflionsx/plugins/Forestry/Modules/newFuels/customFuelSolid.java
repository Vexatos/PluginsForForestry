...
import denoflionsx.core.PfFFuelManager;
...
public class customFuelSolid {
    ...
    private void recipe() {
        ...
        for (ItemStack i : containers) {
            FMLWrapper.MODE.FML.addShapelessRecipe(API.getItem(this.nameLowerCaseNoSpaces), new Object[]{API.getItem("infusionbar"), i});
        }
    }
}
