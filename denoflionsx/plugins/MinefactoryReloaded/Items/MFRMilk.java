package denoflionsx.plugins.MinefactoryReloaded.Items;
...
public class MFRMilk{
    ...
    private void create(){
        ...
        if (this.betterFarmingMilkBottle != null){
            ...
            LiquidContainerSystem.createWithOverride(fuel, this.milk.itemID, PfFManagers.ItemManager.getItem("milkbottle"), true);
        }
        PfFManagers.ItemManager.registerItem("milkbucket",Item.bucketMilk);
